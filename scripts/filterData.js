        ...
        if (potentialMultipleValues.Genders[i] === 'female' || potentialMultipleValues.Genders[i] === 'Female'){
          finalListWithDicts.forEach(function(country){
            if (country.Nationality === potentialMultipleValues.Nationality[i]){
              console.log(potentialMultipleValues.Genders[i], potentialMultipleValues.Nationality[i])
              country.Females += 1
              console.log("count females", country.Females)
              console.log("count males", country.Males)
          ...
          finalListWithDicts.forEach(function(country){
            if (country.Nationality === potentialMultipleValues.Nationality[i]){
              // console.log("count malesMALES", country.Males)
              country.Males += 1
              totalMales += 1
            }
          })
